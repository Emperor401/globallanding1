...
import { k as parseURL, e as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, s as sanitizeStatusCode, q as getContext, $ as $fetch, r as defu, v as createHooks, c as createError$1, x as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-ErH6KZl0.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-BqgElbXk.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    meta: __nuxt_page_meta || {},
    component: () => import('./signup-DwVlx8nq.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-iicKA8oz.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DzbgDpFe.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-re-HVa-v.mjs'));
...
export { _export_sfc as _, useRouter as a, useRoute as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useNuxtApp as u };
